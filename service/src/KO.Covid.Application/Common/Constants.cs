namespace KO.Covid.Application
{
    ...
    public static class Constants
    {
        ...
        public static readonly TimeSpan TemporaryCredentialCacheDuration = TimeSpan.FromMinutes(2);
        public static readonly TimeSpan CredentialCacheDuration = TimeSpan.FromMinutes(50);
